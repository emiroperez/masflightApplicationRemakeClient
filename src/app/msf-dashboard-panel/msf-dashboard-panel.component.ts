...
export class MsfDashboardPanelComponent implements OnInit {
  ...
  loadTableData(moreResults, handlerSuccess, handlerError): void
  {
    ...
    urlBase += "&MIN_VALUE=0&MAX_VALUE=999&minuteunit=m&pageSize=500&page_number=" + this.actualPageNumber+"&token="+tokenResultTable+"&sortingColumns=" + this.values.ListSortingColumns;
  ...
  loadTableDataSorting(ListSortingColumns, handlerSuccess, handlerError): void
  {
    ...
    urlBase += "&MIN_VALUE=0&MAX_VALUE=999&minuteunit=m&pageSize=50&page_number=" + this.actualPageNumber+"&token="+tokenResultTable+"&sortingColumns=" + ListSortingColumns;
    urlArg = encodeURIComponent (urlBase);
